      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-secondary py-20">
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a
              href={primaryAction.href}
              className="btn btn-lg border-0 bg-white text-primary shadow-xl hover:bg-white/90 gap-2"
            >
            ...
            {secondaryAction && (
              <a
                href={secondaryAction.href}
                className="btn btn-lg btn-outline border-white/30 text-white hover:bg-white/10 hover:border-white/50 gap-2"
              >
